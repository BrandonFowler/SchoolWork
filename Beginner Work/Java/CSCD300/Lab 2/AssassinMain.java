...
//AssasinMain.java(Part of Assignment 2)
//Class:CSCD 300
...
Created 1/18/2013, No Changes made since.
</pre>  
...
public class AssassinMain {
	...
	/**
	Main.
	Read files, calls methods and constructors, and displays menu as the game runs.   
	<p><b>
	Extra Credit: 
	</b><pre> 
	N/A
	...
	*/
    ...
    public static void oneKill(Scanner console, AssassinManager manager) {
	 ...
	 /**
	 yesTo() asks the user a question, forcing an answer of "y" or "n";
    returns true if the answer was yes, returns false otherwise
	 @param       console, prompt
 	 @return	Boolean
	 */ 
